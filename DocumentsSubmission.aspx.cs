...
public partial class ClientReferral : System.Web.UI.Page
{
    ...
    {
        string button = "<button class=\"button hover-blue\">" +
    ...
    "</svg> Show </button>";
        ...
        foreach (var document in documents)
        {
            ...
            litDocuments.Text = "<div class='col-md-12 mt-3'><div id='doc_" + benefitCode + "'>Document Name: " + document.ClaimsDocumentsName + "</div>" + Environment.NewLine + button + "</div>";
